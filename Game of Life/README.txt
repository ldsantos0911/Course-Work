...
At present, the only feature this implementation incorporates is the ability to
use a few different themes for the game of life.

One runs the program by typing:

$python3 gol.py [cool|warm|mono]
